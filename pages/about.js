...
const about = () => {
  return (
    <div>
      <Head><title>Auth | About</title></Head>
      <section className="text-gray-600 body-font">
        ...
        <div className="relative mx-auto text-xl h-24 w-22 bg-white rounded-full flex items-center justify-center">
          ...
          <div className="text-center lg:w-2/3 w-full">
            <h1 className="title-font sm:text-4xl text-3xl  my-4 font-medium text-gray-900">About Us</h1>
            <p className="mb-8 leading-relaxed">At Bharat Intern, we are passionate about empowering innovations that shape a better future for businesses and individuals alike.
